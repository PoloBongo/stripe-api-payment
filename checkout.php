...
<div class="row">
    <div class="col-md-6">
        <div class="form-container">
            <form autocomplete="off" action="checkout-charge.php" method="POST">
                ...
                data-key="pk_test_51MVI6oGUygaHYSJ3HFkbVseGrf5zi0xJsSJHXsZA1IRNGxTWUK7WvyPXeqGP1kgCUiiy7dvNXmJNckb8jjV6RKtv001K3Wo87e"
    ...
    <button type="submit" class="button-buy">Payer</button>
            </form>
        </div>
    </div>
    <div class="col-md-6">
